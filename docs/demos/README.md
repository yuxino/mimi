# mimi interface demonstration

The animated preview and MP4 show interactions with the actual production frontend at `4bbcde72b9bcb9a2540f0b230c8ce45d842a50dc`. The recording uses original sample documents and documentation-only substitutes for native API boundaries, not a native macOS/Windows session.

**Scope:** Settings UI · built-in browser preview · no live transcription.
...
<!-- demo-pacing -->
Playback is paced at **2×** the original recording (33.04s → 16.52s). The MP4 and animated preview have matching timing; all scenes, captions and sample-data disclosures are retained.
<!-- /demo-pacing -->
