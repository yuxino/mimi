...
- **macOS 13 or later**: the first session asks for Screen & System Audio Recording access (mimi captures system audio only, does not record the screen, and excludes its own sound).
