...
const SETTINGS_ZH = {
  ...
  blendBackgroundHelp: "去掉半透明卡片和功能按钮，只保留画面上的字幕。点击字幕上的语言条即可恢复背景。",
  lockPosition: "锁定字幕位置",
...
const SETTINGS_EN = {
  ...
  blendBackgroundHelp: "Removes the translucent card and controls, leaving only subtitles over the picture. Click the language bar on the subtitles to restore the background.",
  lockPosition: "Lock Subtitle Position",
...
const SETTINGS_JA = {
  ...
  blendBackgroundHelp: "半透明カードと操作ボタンを消し、映像上の字幕だけを残します。字幕上の言語バーをクリックすると背景を戻せます。",
  lockPosition: "字幕の位置を固定",
