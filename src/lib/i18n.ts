...
const SETTINGS_ZH = {
  ...
  installUpdate: "安装更新",
  installAndCloseWindows: "安装并关闭 Mimi",
  installingUpdate: "正在安装…",
  installingWindowsUpdate: "正在启动安装程序，Mimi 将关闭…",
  restartAndFinishUpdate: "重新启动并完成更新",
  restartingUpdate: "正在重新启动…",
  restartRequested: "已请求重新启动。",
  windowsInstallerStarted: "安装程序已启动；完成安装后请手动打开 Mimi。",
  retryUpdate: "重试",
...
const SETTINGS_EN = {
  ...
  installAndCloseWindows: "Install and Close Mimi",
  installingUpdate: "Installing…",
  installingWindowsUpdate: "Starting the installer; Mimi will close…",
  ...
  windowsInstallerStarted:
    "The installer started. Open Mimi manually after installation finishes.",
  retryUpdate: "Retry",
...
const SETTINGS_JA = {
  ...
  installAndCloseWindows: "インストールして Mimi を終了",
  installingUpdate: "インストール中…",
  installingWindowsUpdate: "インストーラーを起動しています。Mimi は終了します…",
  restartAndFinishUpdate: "再起動して更新を完了",
  restartingUpdate: "再起動中…",
  restartRequested: "再起動を要求しました。",
  windowsInstallerStarted:
    "インストーラーが起動しました。完了後に Mimi を手動で開いてください。",
  retryUpdate: "再試行",
